<h2>1004. Max Consecutive Ones III</h2><h3>Medium</h3><hr><div><p>Given an array <code>A</code>&nbsp;of 0s and 1s, we may change up to <code>K</code>&nbsp;values from 0 to 1.</p>
