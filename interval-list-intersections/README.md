<h2>986. Interval List Intersections</h2><h3>Medium</h3><hr><div><p>Given two lists&nbsp;of <strong>closed</strong> intervals, each list of intervals is pairwise disjoint and in sorted order.</p>
