<h2>1007. Minimum Domino Rotations For Equal Row</h2><h3>Medium</h3><hr><div><p>In a row of dominoes, <code>A[i]</code> and <code>B[i]</code> represent the top and bottom halves of the <code>i<sup>th</sup></code> domino.&nbsp; (A domino is a tile with two numbers from 1 to 6 - one on each half of the tile.)</p>
