<h2>955. Delete Columns to Make Sorted II</h2><h3>Medium</h3><hr><div><p>You are given an array of <code>n</code> strings <code>strs</code>, all of the same length.</p>
