<h2>284. Peeking Iterator</h2><h3>Medium</h3><hr><div><p>Design an iterator that supports the <code>peek</code> operation on a list in addition to the <code>hasNext</code> and the <code>next</code> operations.</p>
