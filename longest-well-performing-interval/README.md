<h2>1124. Longest Well-Performing Interval</h2><h3>Medium</h3><hr><div><p>We are given <code>hours</code>, a list of the number of hours&nbsp;worked per day for a given employee.</p>
