<h2>1288. Remove Covered Intervals</h2><h3>Medium</h3><hr><div><p>Given a list of <code>intervals</code>, remove all intervals that are covered by another interval in the list.</p>
