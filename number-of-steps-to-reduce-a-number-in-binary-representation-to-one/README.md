<h2>1404. Number of Steps to Reduce a Number in Binary Representation to One</h2><h3>Medium</h3><hr><div><p>Given a number&nbsp;<code>s</code> in their binary representation. Return the number of steps to reduce it to 1 under the following rules:</p>
