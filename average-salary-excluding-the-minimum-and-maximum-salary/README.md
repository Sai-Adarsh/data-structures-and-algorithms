<h2>1491. Average Salary Excluding the Minimum and Maximum Salary</h2><h3>Easy</h3><hr><div><p>Given an array of <strong>unique</strong> integers <code>salary</code>&nbsp;where <code>salary[i]</code> is the salary of the employee <code>i</code>.</p>
